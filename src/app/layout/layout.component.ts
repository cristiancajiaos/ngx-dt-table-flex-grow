...
export class LayoutComponent implements OnInit {
  /* Datos */
  public columnas = [
    { name: 'Título', prop: 'titulo', width: 200, flex: 1 },
    { name: 'Año', prop: 'annio', width: 125, flex: 1 },
    { name: 'Director', prop: 'director', width: 150, flex: 1 },
    { name: 'Escritor', prop: 'escritor', width: 250, flex: 1 },
    { name: 'Género', prop: 'genero', width: 200, flex: 1 },
    { name: 'Duración (min)', prop: 'duracion', width: 100, flex: 1 },
  ];
